  ...
  return (
    <div className="p-4 border-l min-w-[400px] flex flex-col h-[calc(100vh-64px)]">
            ...
            {order.items.map((item) => (
              <div key={item.id} className="flex items-center gap-4 bg-gray-50 p-3 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button onClick={() => onDeleteItem?.(item.id)} className="text-red-400 hover:text-red-600">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button onClick={() => onUpdateQuantity?.(item.id, item.quantity + 1)} className="w-8 h-8 flex items-center justify-center border rounded-full hover:bg-gray-100">
      ...
      <div className="space-y-4 pt-4 border-t mt-4">
        ...
        <Button className="w-full" variant="default" onClick={onPlaceOrder}>
          Place Order
        </Button>
      </div>
    </div>
