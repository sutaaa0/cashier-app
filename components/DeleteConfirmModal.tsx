    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white border-[6px] border-black rounded-lg p-8 w-full max-w-md transform rotate-1 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-black uppercase tracking-tighter">Confirm Delete</h2>
        ...
        <div className="mb-8">
          ...
          <p className="text-center text-xl font-bold mb-2">Are you sure you want to delete?</p>
