...
export function TransactionDetails({
  ...
  return (
    <div className="text-text border-2 border-border dark:border-darkBorder shadow-light dark:shadow-dark hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none dark:hover:shadow-none transition-all p-3">
      <h2 className="text-2xl font-bold mb-4 transform -rotate-1 inline-block">Transaction Details</h2>
      ...
      {transactionDetails && (
        <div className="mt-4 p-4 border-2 border-black">
          <p>
            <strong>Date:</strong> {new Date(transactionDetails.tanggalPenjualan).toLocaleString()}
          </p>
          <p>
            <strong>Total:</strong> {formatRupiah(transactionDetails.total_harga)}
          </p>
          <p>
            <strong>Money In:</strong> {formatRupiah(transactionDetails.uangMasuk || 0)}
          </p>
          <p>
            <strong>Return:</strong> {formatRupiah(transactionDetails.kembalian || 0)}
          </p>
        </div>
      )}
    </div>
