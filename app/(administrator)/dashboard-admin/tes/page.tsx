...
import { getTransactions, getProducts, getPelanggan } from "@/server/actions"
import { formatRupiah } from "@/lib/formatIdr"
import { SalesTrend } from "./SalesTrand"
    ...
    <div className="min-h-screen bg-[#F3F3F3] p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white border-4 border-black p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transform rotate-1">
          ...
          <p className="text-3xl font-black">{formatRupiah(revenueData[revenueTimePeriod])}</p>
          <div className="flex items-center mt-2 text-green-500">
            <ArrowUp size={20} />
            <span className="font-bold">12% vs previous period</span>
          </div>
        </div>
