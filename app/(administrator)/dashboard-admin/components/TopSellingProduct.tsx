...
const topProducts = [
  { name: "Espresso", sales: 450, growth: "+15%" },
  { name: "Latte", sales: 300, growth: "+12%" },
  { name: "Cappuccino", sales: 250, growth: "+8%" },
  { name: "Mocha", sales: 200, growth: "+5%" },
  { name: "Americano", sales: 180, growth: "+3%" },
];
